...
render: function(){
  ...
  <ul className="nav navbar-nav navbar-left ">
    ...
    <ul className="unstyled inbox-pagination pull-left" >
                                ...
                                <li>
                                    <a className="np-btn" id="paddingright"><b><i>SHANTHI GURU</i></b></a>
                                </li>
            ...
            <div id="profile">
                  ...
                  <a className="twPc-avatarLink pull-right">
                              <img alt="Mert Salih Kaplan" src="http://vignette4.wikia.nocookie.net/logopedia/images/5/54/Gmail_icon.png/revision/latest?cb=20150709135925" className="twPc-avatarImg" />
                  </a>
